...
namespace MultiUserMVC.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        //Added custom user properties to InputModel
        ...
        public async Task<IActionResult> OnPostAsync(string ImgUrl, string returnUrl = null)
        {
            ...
            //Check if the cropped image was sent 
            ...
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
                ...
                var result = await _userManager.CreateAsync(user, Input.Password); //This we create a new user and store them in the database
                if (result.Succeeded)
                {
